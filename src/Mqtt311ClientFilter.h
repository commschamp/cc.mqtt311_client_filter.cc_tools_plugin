...
static_assert(CC_MQTT311_CLIENT_MAKE_VERSION(1, 0, 9) <= CC_MQTT311_CLIENT_VERSION, "The version of the cc_mqtt311_client library is too old");
static_assert(CC_TOOLS_QT_MAKE_VERSION(6, 0, 9) <= CC_TOOLS_QT_VERSION, "The version of the cc_tools_qt library is too old");
